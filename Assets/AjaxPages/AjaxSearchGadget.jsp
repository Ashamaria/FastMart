...
<%
    ...
    if (request.getParameter("action") != "") {
        ...
        String sqlQry = "SELECT * FROM tbl_gadget d INNER JOIN tbl_gadgetbrand db ON d.gdbrnd_id = db.gdbrnd_id where true ";
        String row = "SELECT count(*) as count FROM tbl_gadget d INNER JOIN tbl_gadgetbrand db ON d.gdbrnd_id = db.gdbrnd_id where true ";
