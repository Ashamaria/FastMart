...
<%
    ...
    if (request.getParameter("action") != "") {
        ...
        String sqlQry = "SELECT * FROM tbl_footwear f INNER JOIN tbl_footwearbrand fb ON f.ftwrbrnd_id = fb.ftwrbrnd_id where true ";
        String row = "SELECT count(*) as count FROM tbl_footwear f INNER JOIN tbl_footwearbrand fb ON f.ftwrbrnd_id = fb.ftwrbrnd_id where true ";

        if (!request.getParameter("brand").equals("")) {

            String brand = request.getParameter("brand");

            sqlQry += "AND f.ftwrbrnd_id IN('" + brand + "')";
            row += "AND f.ftwrbrnd_id IN('" + brand + "')";
        }
        ...
        if (!request.getParameter("gender").equals("")) {
            ...
            sqlQry += "AND ftwr_gndr IN('" + gender + "')";
            row += "AND ftwr_gndr IN('" + gender + "')";
        }
        ...
        if (!request.getParameter("isformal").equals("")) {

            String isformal = request.getParameter("isformal");

            sqlQry += "AND ftwr_isfrml IN('" + isformal + "')";
            row += "AND ftwr_isfrml IN('" + isformal + "')";
        }
