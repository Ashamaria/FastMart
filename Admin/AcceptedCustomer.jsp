...
<html lang="en" >
    ...
    <%  
        if (request.getParameter("rid") != null) {
                ...
                String upQry = "update tbl_customer set cust_sts='1' where cust_id='" + request.getParameter("rid") + "'";
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_customer c inner join tbl_district d on d.dist_id=c.dist_id where cust_sts='0'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="AcceptedCustomer.jsp?rid=<%=rs.getString("cust_id")%>"><img src="../Assets/Template/Admin/img/menu-icon/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
