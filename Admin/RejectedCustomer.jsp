...
<html lang="en" >
    ...
    <%  
        if (request.getParameter("aid") != null) {
                ...
                String upQry = "update tbl_customer set cust_sts='0' where cust_id='" + request.getParameter("aid") + "'";
    ...
    %>
    <body>
        <h1 align="center" id="heading">Customer Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_customer c inner join tbl_district d on d.dist_id=c.dist_id where cust_sts='1'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="RejectedCustomer.jsp?aid=<%=rs.getString("cust_id")%>"><img src="../Assets/Template/Admin/img/menu-icon/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
