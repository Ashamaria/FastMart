...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_deliveryboy c inner join tbl_place p on p.plc_id=c.plc_id inner join tbl_district d on d.dist_id=p.dist_id where dlvryby_sts='1'";
