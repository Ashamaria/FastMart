...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_shop s inner join tbl_shoptype st on st.shtyp_id=s.sh_typ";
                    ResultSet rs = con.selectCommand(selQry);
                    while (rs.next()) {
                        if (rs.getString("shtyp_typ").equals("Gadget")) {
                            String selQry1 = "select * from tbl_gadget where sh_id = '" + rs.getString("sh_id") + "'";
                            ResultSet rs1 = con.selectCommand(selQry1);
                            while (rs1.next()) {
                                String selQry2 = "select COALESCE(sum(cart_qty),0) as cart_qty from tbl_cart where gd_id = '" + rs1.getString("gd_id") + "'";
                                ResultSet rs2 = con.selectCommand(selQry2);
                                if (rs2.next()) {
                                    %>
                                    <tr>
                                        <td><%=rs.getString("sh_nme")%></td>
                                        <td><%=rs1.getString("gd_ctgry")%></td>
                                        <td><%=rs2.getString("cart_qty")%></td>
                                    </tr>
                                    <%
                                }
                            }
                            ...
                            String selQry1 = "select * from tbl_footwear where sh_id = '" + rs.getString("sh_id") + "'";
                            ResultSet rs1 = con.selectCommand(selQry1);
                            while (rs1.next()) {
                                String selQry2 = "select COALESCE(sum(cart_qty),0) as cart_qty from tbl_cart where ftwr_id = '" + rs1.getString("ftwr_id") + "'";
                                ResultSet rs2 = con.selectCommand(selQry2);
                                if (rs2.next()) {
                                    %>
                                    <tr>
                                        <td><%=rs.getString("sh_nme")%></td>
                                        <td><%=rs1.getString("ftwr_ctgry")%></td>
                                        <td><%=rs2.getString("cart_qty")%></td>
                                    </tr>
                                    <%
                                }
                            ...
                            String selQry1 = "select * from tbl_utensil where sh_id = '" + rs.getString("sh_id") + "'";
                            ResultSet rs1 = con.selectCommand(selQry1);
                            while (rs1.next()) {
                                String selQry2 = "select COALESCE(sum(cart_qty),0) as cart_qty from tbl_cart where utsl_id = '" + rs1.getString("utsl_id") + "'";
                                ResultSet rs2 = con.selectCommand(selQry2);
                                if (rs2.next()) {
                                    %>
                                    <tr>
                                        <td><%=rs.getString("sh_nme")%></td>
                                        <td><%=rs1.getString("utsl_ctgry")%></td>
                                        <td><%=rs2.getString("cart_qty")%></td>
                                    </tr>
                                    <%
                                }
                            ...
                            String selQry1 = "select * from tbl_dress where sh_id = '" + rs.getString("sh_id") + "'";
                            ResultSet rs1 = con.selectCommand(selQry1);
                            while (rs1.next()) {
                                String selQry2 = "select COALESCE(sum(cart_qty),0) as cart_qty from tbl_cart where drs_id = '" + rs1.getString("drs_id") + "'";
                                ResultSet rs2 = con.selectCommand(selQry2);
                                if (rs2.next()) {
                                    %>
                                    <tr>
                                        <td><%=rs.getString("sh_nme")%></td>
                                        <td><%=rs1.getString("drs_ctgry")%></td>
                                        <td><%=rs2.getString("cart_qty")%></td>
                                    </tr>
                                    <%
                                }
                            ...
                            String selQry1 = "select * from tbl_grocery g inner join tbl_grocerysubcategory gsc on gsc.grcrysubctgry_id=g.grcry_subctgry_id inner join tbl_grocerycategory gc on gc.grcryctgry_id=gsc.grcryctgry_id where sh_id = '" + rs.getString("sh_id") + "'";
                            ResultSet rs1 = con.selectCommand(selQry1);
                            while (rs1.next()) {
                                String selQry2 = "select COALESCE(sum(cart_qty),0) as cart_qty from tbl_cart where grcry_id = '" + rs1.getString("grcry_id") + "'";
                                ResultSet rs2 = con.selectCommand(selQry2);
                                if (rs2.next()) {
                                    %>
                                    <tr>
                                        <td><%=rs.getString("sh_nme")%></td>
                                        <td><%out.println(rs1.getString("grcrysubctgry_nme")+"("+rs1.getString("grcryctgry_nme")+")");%></td>
                                        <td><%=rs2.getString("cart_qty")%></td>
                                    </tr>
                                    <%
                                }
