...
<html lang="en" >
    ...
    <%  
        if (request.getParameter("aid") != null) {
                ...
                String upQry = "update tbl_deliveryboy set dlvryby_sts='1' where dlvryby_id='" + request.getParameter("aid") + "'";
        ...
        if (request.getParameter("rid") != null) {
                ...
                String upQry = "update tbl_deliveryboy set dlvryby_sts='2' where dlvryby_id='" + request.getParameter("rid") + "'";
                if (con.executeCommand(upQry)) {
    ...
    %>
    <body>
        <h1 align="center" id="heading">Delivery Boy Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_deliveryboy c inner join tbl_place p on p.plc_id=c.plc_id inner join tbl_district d on d.dist_id=p.dist_id where dlvryby_sts='0'";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("dlvryby_nme")%></td>
                    <td><%=rs.getString("dist_nme")%></td>
                    <td><%=rs.getString("plc_nme")%></td>
                    <td><%=rs.getString("dlvryby_contct")%></td>
                    <td><%=rs.getString("dlvryby_email")%></td>
                    <td align="center">
                        <a href="NewDeliveryBoy.jsp?aid=<%=rs.getString("dlvryby_id")%>"><img src="../Assets/Template/Admin/img/menu-icon/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="NewDeliveryBoy.jsp?rid=<%=rs.getString("dlvryby_id")%>"><img src="../Assets/Template/Admin/img/menu-icon/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
