        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <a href="SizeChart.jsp"><h5 class="text-right" id="textChange">Size Chart</h5></a>
                    <hr>
                    ...
                    <div class="row" id="result">
                        ...
                        <%
                            String selProduct = "SELECT * from tbl_dress d inner join tbl_dressbrand db on db.drsbrnd_id=d.drsbrnd_id";
