<%-- 
    Document   : ViewGroceryProduct
    Created on : 18 Nov, 2021, 9:13:44 PM
    Author     : ajula
--%>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row" id="result">
                        <%
                            String selProduct = "select * from tbl_grocery g inner join tbl_grocerysubcategory gsc on gsc.grcrysubctgry_id=g.grcry_subctgry_id inner join tbl_grocerycategory gc on gc.grcryctgry_id=gsc.grcryctgry_id where sh_id='" + request.getParameter("id")+"'";
